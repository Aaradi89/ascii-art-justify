echo go run . --align=center "hello" standard
go run . --align=center "hello" standard
echo ----------------------------------------------------------------
echo go run . --align=left "Hello There" standard
go run . --align=left "Hello There" standard
echo ----------------------------------------------------------------
echo go run . --align=right "hello" shadow
go run . --align=right "hello" shadow
echo ----------------------------------------------------------------
echo go run . --align=justify "how are you" shadow
